...
export default function CreateEdit(props) {
    ...
    const [activeSectionKey, setActiveSectionKey] = useState(Object.keys(sections)[0]); //using the first section as the state.
  ...
  return (
    <div className={styles.container}>
        ...
        <div className={styles.header}> {/* Header Section Start */}
            {Object.keys(sections)?.map((key)=>(
                <div 
                className={`${styles.section} ${activeSectionKey === key ? styles.active : ""}`}   //if current key is equal to statekey then we apply active class(style) on it.
                key={key}
        ...
        {/* <div className={styles.body}>  Body Section Start 
